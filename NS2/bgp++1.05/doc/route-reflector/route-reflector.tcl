...
# Create the NODE nodes and BGP applications
...
$ns duplex-link $NODE4 $NODE2 1.5Mb 1ms DropTail
$ns duplex-link $NODE4 $NODE3 1.5Mb 1ms DropTail
puts "Connecting NODE 5"
$ns duplex-link $NODE5 $NODE2 1.5Mb 1ms DropTail
$ns duplex-link $NODE5 $NODE3 1.5Mb 1ms DropTail
puts "Connecting NODE 6"
$ns duplex-link $NODE6 $NODE1 1.5Mb 1ms DropTail
$ns duplex-link $NODE6 $NODE2 1.5Mb 1ms DropTail
$ns duplex-link $NODE6 $NODE3 1.5Mb 1ms DropTail
...
$ns duplex-link $NODE10 $NODE3 1.5Mb 1ms DropTail
puts "Connecting NODE 11"
$ns duplex-link $NODE11 $NODE2 1.5Mb 1ms DropTail
puts "Connecting NODE 12"
$ns duplex-link $NODE12 $NODE5 1.5Mb 1ms DropTail
puts "created 16 peering agreements"
...
$ns at 99 "$BGP12 command \"show ip bgp \""
