...
#$ns at 25 "$BGP3 command \"no network 10.0.3.0/24\""

$ns at 22 "$BGP5 command \"network 10.0.3.0/24\""
$ns at 26 "$BGP5 command \"no network 10.0.3.0/24\""

#$ns at 35 "$BGP2 command \"show ip bgp \""
#$ns at 35 "$BGP1 command \"show ip bgp \""

#$ns at 90 "$BGP3 command \"network 10.0.3.0/24\""
#$ns at  "$BGP3 command \"no network 10.0.3.0/24\""
